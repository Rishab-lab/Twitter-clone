  ...
  return (
    ...
    <div className={style.wrapper}>
      <div className={style.feed__header}>
        ...
        <img className={style.container} alt="Myimg.jpeg" src="https://www.shutterstock.com/shutterstock/videos/1023025072/thumb/1.jpg?ip=x480" />
      <div>
...
<div key={Data.id} className={style.textcontaint}>
        ...
        <h5 style={{marginTop:'1rem',fontSize:'1.2rem'}}> Old Spice: “The original. If your grandfather hadn’t worn it, you wouldn’t exist.”</h5>
